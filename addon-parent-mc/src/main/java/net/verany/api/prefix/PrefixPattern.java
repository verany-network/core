...
public class PrefixPattern extends AbstractPrefixPattern {
    ...
    public static final AbstractPrefixPattern CLEAN_YELLOW = new PrefixPattern("CLEAN_YELLOW", "§8[§e§l{0}§6§l{1}§8] §r", new PrefixColor(ChatColor.YELLOW, ChatColor.GOLD));
    public static final AbstractPrefixPattern CLEAN_RED = new PrefixPattern("CLEAN_RED", "§8[§c§l{0}§4§l{1}§8] §r", new PrefixColor(ChatColor.RED, ChatColor.DARK_RED));
